...
export default function RelevantJobsPage() {
  ...
  const [jobs, setJobs] = useState<Job[]>(RELEVANT_JOBS);
  const [filteredJobs, setFilteredJobs] = useState<Job[]>(RELEVANT_JOBS);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-primary mb-2">Relevant Jobs</h1>
