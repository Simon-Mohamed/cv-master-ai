      ...
      <div className="max-w-4xl mx-auto p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Select your skills and let AI generate personalized interview
            questions
          </p>
        </div>
      ...
      <Dialog open={showNoSkillsModal} onOpenChange={setShowNoSkillsModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              You need to add at least 3 skills to generate personalized
              interview questions.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showQuickAddModal} onOpenChange={setShowQuickAddModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Add skills quickly without leaving this page. You need at least 3
              skills.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 mt-4">
