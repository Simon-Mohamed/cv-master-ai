    ...
    try {
      const storedVersion =
        typeof window !== "undefined"
          ? localStorage.getItem("cvmaster_storage_version")
          : null;
      ...
      const userData =
        typeof window !== "undefined"
          ? localStorage.getItem("cvmaster_user")
          : null;
      if (userData) {
      ...
      const saved =
        typeof window !== "undefined"
          ? localStorage.getItem("cvmaster_cv")
          : null;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-card rounded-lg shadow-lg p-6 max-w-sm w-full mx-4 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Your CV has been saved. You can safely leave this page or continue
              editing.
            </p>
            <Button
